...
<img class="post_center_img_noborder" src="http://learnopengl.com/img/advanced/blending_equation.png"/>
...
<img class="post_center_img_noborder" src="http://learnopengl.com/img/advanced/blending_equation_mixed.png"/>
...
GL_ZERO  |	0
GL_ONE	 |  1
GL_SRC_COLOR |	$$\bar{\color{green}C}_{source}$$向量
...
GL_CONSTANT_COLOR	   | $$\bar{\color{blue}C}_{constant}$$
