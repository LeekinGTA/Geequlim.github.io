...
<table class="table table-bordered">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>GL_LINES_ADJACENCY或GL_LINE_STRIP_ADJACENCY（4）</td>
    </tr>
    <tr>
      <td>triangles</td>
...
<img class="post_center_img_noborder" src="http://learnopengl.com/img/advanced/geometry_shader_triangle_strip.png"/>
